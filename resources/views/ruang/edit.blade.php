        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Sunting Ruangan</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        Ubah informasi mengenai ruangan yang dipilih.
                    </p>
                </div>
            </div>
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-input type="text" id="code" placeholder="R01" class="mt-1 block w-full text-sm" value="{{ $data->code }}" disabled="true" readonly="true"/>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-input type="text" name="name" id="name" placeholder="Ruang 1" class="mt-1 block w-full text-sm" value="{{ $data->name ?? old('name') }}"/>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1">
                                    <x-textarea id="description" name="description" rows="3" placeholder="Ruangan Teori 01" class="mt-1 blcok w-full text-sm">{{ $data->description ?? old('description') }}</x-textarea>
                                </div>
